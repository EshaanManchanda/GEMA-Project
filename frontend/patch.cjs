                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex items-center text-gray-700">
                      ...
                      <span>{event.dateSchedule?.[0]?.startTime && event.dateSchedule?.[0]?.endTime ? \`\${event.dateSchedule[0].startTime} - \${event.dateSchedule[0].endTime}\` : '50 min'}</span>
                    </div>
                    <div className="flex items-center text-gray-700">
                    ...
                    <div className="flex items-center text-gray-700">
                      ...
                      <span>Ages {Array.isArray(event.ageRange) ? \`\${Math.min(event.ageRange[0], event.ageRange[1])}-\${Math.max(event.ageRange[0], event.ageRange[1])}\` : event.ageRange}</span>
                    </div>
                    <div className="flex items-center text-gray-700">
...
// Replace the old booking panel with the new logic
...
// And if it is educational, the booking panel is placed before the modern sidebar
const finalContent = removedBookingPanelContent.substring(0, insertIndex) + `
              {isEducational && (
                <div className="mt-8">
                  ${bookingPanelContent}
                </div>

...
import { FaArrowRight, FaRedo, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
  ...
  const fetchCollections = async (isRetry = false) => {
    try {
      ...
      if (import.meta.env.DEV || import.meta.env.VITE_DEBUG_API === 'true') {
        console.log('CollectionPills: Collections fetched:', fetchedCollections.length);
      }
      ...
      console.error('CollectionPills: Error fetching collections:', err);
      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="relative flex items-center justify-center pb-8 md:pb-0 md:mx-8" style={{ minHeight: '80px' }}>
          ...
          <div
            ...
            className="flex gap-2 sm:gap-3 overflow-x-auto scrollbar-hide scroll-smooth px-1 items-center"
            role="list"
              ...
              return (
                <div key={collectionId || index} role="listitem">
                  <button
                    ...
                    className={`
                      flex-shrink-0 px-5 sm:px-6 py-2.5 sm:py-3 m-5 rounded-full

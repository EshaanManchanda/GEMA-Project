...
const ReviewSubmissionForm: React.FC<ReviewSubmissionFormProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl">
      {hasAlreadyReviewed || isSubmitted ? (
        // Thank you message
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">
            Your review has been submitted successfully and will help other users make informed decisions.
          </p>
          <p className="text-sm text-gray-500">
            You can edit or delete your review from your profile page if needed.
          </p>
        </div>
      ) : (
        // Review form

...
const SEOEditor: React.FC<SEOEditorProps> = ({
  ...
  const handleAutoGenerate = () => {
    ...
    if (!contentData.title || !contentData.description) {
      logger.warn('Cannot auto-generate SEO: title or description is missing');
      return;
    }
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <CharacterCounter
                ...
                optimal={SEO_LIMITS.TITLE as any}
              />
            </div>
            <Input
              value={seoData.title}
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <CharacterCounter
                ...
                optimal={SEO_LIMITS.DESCRIPTION as any}
              />
            </div>
            <textarea
              ...
              rows={3}
              title={!canEditSEO.allowed ? canEditSEO.message : undefined}
              className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none ${seoData.description.length > SEO_LIMITS.DESCRIPTION.MAX ? 'border-red-300' : ''
                }`}
            />
          </div>

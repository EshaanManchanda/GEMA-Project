      ...
      <div className="max-w-screen-xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8">
          {uaeCities.map((city) => (
            ...
            >
              <div className="w-28 h-28 md:w-32 md:h-32 rounded-full overflow-hidden mb-3 shadow-md transition-transform duration-300 group-hover:scale-110 group-hover:shadow-lg">
                <img
                  src={city.image}

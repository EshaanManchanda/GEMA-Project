...
class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo): void {
    ...
    if (import.meta.env.DEV && (
      ...
      logger.warn('[Dev Only] Hot module reload error (safe to ignore):', error.message);
    ...
    // 🔴 BLANK SCREEN DEBUG: Log full crash details
    if (import.meta.env.DEV) {
      logger.error(`[ErrorBoundary] 🔴 CRASH CAUGHT (context: ${this.props.context || 'unknown'})`, {

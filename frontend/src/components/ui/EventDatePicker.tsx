                  ...
                  <div className="mt-2 space-y-1">
                    ...
                    <div className="flex items-center gap-4 text-xs">
                      <span className="inline-flex items-center gap-1 text-green-700">
                        ✅ {schedule.unlimitedSeats || schedule.availableSeats >= 999999 ? 'Unlimited seats' : `${schedule.availableSeats} seats available`}
                      </span>
                      <span className={`inline-flex items-center gap-1 font-medium ${schedule.price === 0 ? 'text-green-700' : 'text-primary-700'}`}>

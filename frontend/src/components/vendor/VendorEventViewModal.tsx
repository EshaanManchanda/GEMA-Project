    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {/* Educational Details */}
          {['Class', 'Bootcamp', 'Masterclass', 'Course', 'Workshop'].includes(event.type) && (
            <div className="mb-6 border-t pt-4 border-gray-100">
              <h3 className="font-medium text-emerald-800 mb-3">Educational Details</h3>
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                {event.topic && (
                  <div>
                    ...
                    <p className="text-gray-900">{event.topic}</p>
                  </div>
                )}
                {event.introVideo && (
                  <div className="col-span-2">
                    <p className="text-sm font-medium text-gray-500">Intro Video</p>
                    <a href={event.introVideo} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm">
                      {event.introVideo}
                    </a>
                  </div>
                )}
                {event.teacherId && typeof event.teacherId === 'object' && (
                  <div className="col-span-2">
                    ...
                    <p className="text-gray-900">{(event.teacherId as any).firstName} {(event.teacherId as any).lastName}</p>
                  </div>
                )}
              </div>

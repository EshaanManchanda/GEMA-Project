...
const BankDetailsForm: React.FC<BankDetailsFormProps> = ({
  ...
  useEffect(() => {
    if (currentDetails) {
      setFormData(prev => ({ ...prev, ...currentDetails }));
      setShowIBAN(isIBANCountry(currentDetails.country));
    }
  }, [currentDetails]);

  const isIBANCountry = (country: string | undefined): boolean => {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${errors.accountHolderName ? 'border-red-500' : 'border-gray-200'
              }`}
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${errors.country ? 'border-red-500' : 'border-gray-200'
              }`}
            disabled={isLoading || saving}
          >
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors ${errors.bankName ? 'border-red-500' : 'border-gray-200'
              }`}
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors font-mono ${errors.accountNumber ? 'border-red-500' : 'border-gray-200'
              }`}
        ...
        {showIBAN ? (
          <div>
            ...
            <input
              ...
              value={formData.iban}
              onChange={handleChange}
              className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors font-mono uppercase ${errors.iban ? 'border-red-500' : 'border-gray-200'
                }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors font-mono ${errors.routingNumber ? 'border-red-500' : 'border-gray-200'
                }`}
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors font-mono uppercase ${errors.swiftCode ? 'border-red-500' : 'border-gray-200'
              }`}

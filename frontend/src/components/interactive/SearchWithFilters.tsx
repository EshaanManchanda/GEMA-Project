...
const SearchWithFilters: React.FC<SearchWithFiltersProps> = ({
  ...
  showRatingFilter: _showRatingFilter = true,
  showCapacityFilter: _showCapacityFilter = false,
  showViewToggle = true,
  showSortOptions: _showSortOptions = true,
  ...
  currencies: _currencies = ['AED', 'USD', 'EUR']
}) => {
  ...
  useEffect(() => {
    ...
    if (enableGeolocation && showLocationSearch && navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          logger.warn('Geolocation access denied', error);
  ...
  const loadFilterOptions = async () => {
    try {
      ...
      setCategories((categoriesResponse as any).data || categoriesResponse);
      ...
      setTimeout(() => {
        ...
        switch (searchFilters.sortBy) {
          ...
          case 'distance':
            ...
            break;
          default:
            filtered.sort((_a, b) => b.isFeatured ? 1 : -1);
        }
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className={`flex items-center px-4 py-3 border rounded-lg transition-colors ${showFilters || activeFiltersCount > 0
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {popularTags.slice(0, 6).map(tag => (
              <button
                ...
                className={`px-3 py-1 rounded-full text-sm border ${filters.tags.includes(tag)

...
const CouponForm: React.FC<CouponFormProps> = ({
  ...
  const handleFormSubmit = async (data: any) => {
    try {
      ...
      logger.error('[CouponForm] Form submission failed:', error);
    }
  };
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {[
                          ...
                          <button
                            ...
                            className={`p-3 border rounded-lg flex flex-col items-center space-y-2 transition-colors ${field.value === type.value
                                ? 'border-blue-500 bg-blue-50 text-blue-700'
                                : 'border-gray-700 hover:border-gray-700 text-gray-900'
                              }`}
                          >
                            {type.icon}

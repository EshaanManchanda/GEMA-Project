...
const announcementSchema = yup.object().shape({
  message: yup.string().required('Announcement is required').min(1).max(200, 'Announcement cannot exceed 200 characters'),
  shortDescription: yup.string().max(500, 'Description cannot exceed 500 characters').optional(),
  link: yup.string()
  ...
  backgroundColor: yup.string()
    .required('Background color or gradient is required'),
            ...
            <div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    {...field}
                    placeholder="Enter announcement text (max 200 characters)"
            ...
            <div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    {...field}
                    placeholder="Enter an optional longer description (e.g., Summer 2026 early bird access...)"
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <div className="flex gap-2">
                      <input
                        type="color"
                        value={field.value.startsWith('#') ? field.value.slice(0, 7) : '#000000'}
                        onChange={(e) => field.onChange(e.target.value)}
                        className="h-10 w-20 rounded cursor-pointer flex-shrink-0"

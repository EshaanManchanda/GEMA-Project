...
import { Lock, AlertCircle, ExternalLink, Info } from 'lucide-react';
          ...
          <div className="space-y-4">
            <PaymentElement
              ...
              onLoadError={(error: any) => {
                ...
                // If the PaymentIntent is already in a terminal state (succeeded),
                // skip the payment form and proceed straight to booking confirmation.
                // This handles the case where payment was collected but confirmation failed.
                const isTerminalState = errorMsg.toLowerCase().includes('terminal state');
                if (isTerminalState) {
                  logger.info('PaymentIntent is in terminal state — attempting booking confirmation');
                  onSuccess();
                  return;
                }

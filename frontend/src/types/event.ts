...
export interface EventDateSchedule {
  _id: string;
  id?: string;
  // Regular events use date/startDateTime/endDateTime
  date?: string;
  startDateTime?: string;
  endDateTime?: string;
  // Teacher events use startDate/endDate
  startDate?: string;
  endDate?: string;
...
export interface PastEventMemory {
  image: string;
  caption?: string;
...
export interface Event {
  ...
  capacity?: number;
  /** IANA timezone name for the event (e.g. "Asia/Dubai"). Default "Asia/Dubai". */
  timezone?: string;
}

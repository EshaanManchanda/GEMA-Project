...
export interface User {
  ...
  phone?: string;
  avatar?: string;
  role: 'customer' | 'vendor' | 'employee' | 'admin' | 'teacher';
...
// Vendor Profile (separate Mongoose document)
...
// Teacher Profile (separate Mongoose document)
...
// Employee Profile (separate Mongoose document)

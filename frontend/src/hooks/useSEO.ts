...
export const useSEO = (seoData: SEOData = {}) => {
  ...
  useEffect(() => {
    ...
    const {
      ...
      ogImage = import.meta.env.VITE_SITE_LOGO || `${baseUrl}/assets/images/Kidrove-log-new.png`,
      ogType = 'website',
  ...
  const generateEventSEO = (event: any): SEOData => {
    ...
    return {
      ...
      ogImage: event.images?.[0] || import.meta.env.VITE_SITE_LOGO || `${baseUrl}/assets/images/Kidrove-log-new.png`,
      ogType: 'article',
      structuredData: {
  ...
  const generateBlogSEO = (blog: any): SEOData => {
    return {
      ...
      ogImage: blog.featuredImage || import.meta.env.VITE_SITE_LOGO || `${baseUrl}/assets/images/Kidrove-log-new.png`,
      ogType: 'article',
      structuredData: {
        '@context': 'https://schema.org',
        '@type': 'BlogPosting',

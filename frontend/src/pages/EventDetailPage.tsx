...
const EventDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['overview', 'about', 'syllabus', 'booking-panel', 'location', 'contact', 'faqs'];
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-6" role="alert">
          ...
          <p>{error}</p>
          <Link to="/search" className="mt-4 inline-block text-primary hover:underline">Browse other events</Link>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-12">
          ...
          <Link to="/search" className="bg-primary text-white px-6 py-2 rounded-md hover:bg-primary-dark transition-colors">
            Browse Events
          </Link>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="sticky top-[80px] z-40 bg-white border-b border-gray-200 shadow-sm mb-8 mt-4 rounded-lg overflow-x-auto whitespace-nowrap">
              <div className="flex px-2">
                ...
                <button
                  className={`py-4 px-6 text-sm font-bold border-b-2 transition-colors ${activeSection === 'contact' ? 'border-primary text-primary' : 'border-transparent text-gray-500 hover:text-gray-900'}`}
            ...
            {/* Contact Section */}
            <div id="contact" className="scroll-mt-32 mt-12 mb-12">
              <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/5 border border-emerald-500/20 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-[0_0_30px_rgba(16,185,129,0.05)] hover:border-emerald-500/30 transition-colors group">
                <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left gap-5">
                  <div className="w-14 h-14 bg-emerald-500/10 rounded-full flex items-center justify-center border border-emerald-500/20 shrink-0 group-hover:scale-105 transition-transform shadow-[0_0_15px_rgba(16,185,129,0.15)]">
                    <svg className="w-7 h-7 text-emerald-500" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-1.5">Need help or have questions?</h3>
                    <p className="text-gray-600 text-sm">Our support team is available on WhatsApp to assist you.</p>
                  </div>
                </div>
                <a
                  ...
                  className="shrink-0 px-7 py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-full transition-all shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] flex items-center gap-2 active:scale-95"
                >
                  Message Us <ChevronRight className="w-5 h-5 stroke-[3]" />
                </a>
              </div>
            </div>
                            ...
                            return (
                              <>
                                ...
                                <div className="flex justify-between text-sm items-center">
                                  ...
                                  <span className="font-semibold text-gray-900">{event.currency || 'AED'} {vat.toFixed(2)}</span>
                                </div>
                                <div className="border-t border-gray-300 pt-3">
                                  <div className="flex justify-between font-bold text-lg items-center">
                                    <span className="text-gray-900">Total</span>
                                    <span className="text-primary-600 text-2xl">{event.currency || 'AED'} {total.toFixed(2)}</span>
                                  </div>
                                </div>
                              </>
                            );

...
const TeacherEventFormPage: React.FC = () => {
  ...
  // Past Event Memories
  const [pastEventMemories, setPastEventMemories] = useState<PastEventMemory[]>([]);
  ...
  useEffect(() => {
    ...
    if (eventData?.teachingEvent) {
      ...
      // Load memories
      setPastEventMemories(event.pastEventMemories || []);
              ...
              >
                <div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6">
                    ...
                    <PastEventMemoriesEditor
                      memories={pastEventMemories}
                      onChange={setPastEventMemories}
                    />
                  </div>
                </div>
              </motion.div>

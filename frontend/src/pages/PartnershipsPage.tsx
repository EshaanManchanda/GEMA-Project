...
const Navbar: React.FC<{ sticky: boolean }> = ({ sticky }) => (
  <nav className={`${sticky ? 'fixed top-0 left-0 right-0 z-50 shadow-lg' : 'sticky top-0 z-40'} bg-white transition-shadow duration-300`}>
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
      <Link to="/" className="font-bold text-2xl">
        <span className="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 bg-clip-text text-transparent">KidRove</span>
      </Link>
      ...
      <button
        ...
        className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-full hover:shadow-lg transition-shadow"
      >
        Request Proposal
      </button>
    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <button
              onClick={() => toast.success('Proposal request feature coming soon!')}
            ...
            <button
              onClick={() => document.getElementById('contact-form')?.scrollIntoView({ behavior: 'smooth' })}
              className="px-8 py-4 bg-white border-2 border-blue-600 text-blue-600 font-bold rounded-full hover:bg-blue-50 transition text-lg"
            >
              Request Proposal
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-lg">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-lg hover:shadow-xl transition-shadow text-lg"
              >
                Request a Proposal
              </button>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div>
          ...
          <p className="text-gray-400 text-sm">Building the future of student engagement.</p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">partnerships@kidrove.com</p>
          <p className="text-gray-400 text-sm">+971 XX XXX XXXX</p>
        </div>

        <div>
          <h4 className="font-bold mb-4">Follow Us</h4>
          <div className="flex gap-4">
            <a href="#" className="text-gray-400 hover:text-white transition text-lg"><FaLinkedin /></a>
            <a href="#" className="text-gray-400 hover:text-white transition text-lg"><FaTwitter /></a>
            <a href="#" className="text-gray-400 hover:text-white transition text-lg"><FaFacebook /></a>
          </div>
        </div>
      </div>

      <div className="border-t border-gray-700 pt-8 text-center text-gray-400 text-sm">
        <p>&copy; 2026 KidRove. All rights reserved.</p>
      </div>
    </div>
  </footer>
);

    ...
    <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-16">
      <div className="text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <button
            onClick={() => toast.success('Register Now feature coming soon!')}
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="bg-white rounded-3xl p-8 md:p-12 border-2 border-gray-200 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  {[...Array(7)].map((_, i) => (
                    <option key={i} value={`Grade ${i + 6}`}>Grade {i + 6}</option>
                  ))}
                </select>
              </div>
            ...
            <button
              type="submit"
              className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-lg rounded-lg hover:shadow-xl hover:scale-105 transition-all duration-200"
            >
              Register Now 🚀
            </button>
  ...
  <section className="py-20 bg-white">
    <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        ...
        <button
          onClick={() => toast.success('Contact form feature coming soon!')}
          className="px-10 py-4 bg-gray-200 text-gray-900 font-bold text-lg rounded-full hover:bg-gray-300 transition-all duration-200"
        >
          👉 Talk to Us
        </button>
      </div>

  ...
  if (loading) {
    return (
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="py-8 px-4 sm:px-6 lg:px-8 w-full max-w-[95vw] sm:max-w-[85vw] lg:max-w-[70vw] mx-auto"
      >
    ...
    >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4">
            <button
              onClick={handleLike}
              disabled={liked}
              className={`flex items-center gap-2 px-3 py-2 sm:px-4 rounded-lg transition-colors text-sm sm:text-base ${liked
            ...
            <button
              onClick={() => handleShare()}
              className="flex items-center gap-2 px-3 py-2 sm:px-4 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 transition-colors text-sm sm:text-base"
            >
              <FaShare />
              <span>Share</span>
            </button>
      ...
      <div className="mb-8 flex justify-center">
        <img
          ...
          alt={blog.title}
          className="w-full max-h-[50vh] sm:max-h-[60vh] lg:max-h-[70vh] object-contain rounded-lg shadow-lg"
          onError={(e) => {
      ...
      {/* Blog excerpt */}
      <div className="mb-6 sm:mb-8 p-4 sm:p-6 bg-gray-50 rounded-lg border-l-4 border-primary-500">
      ...
      <div className="text-center mt-8">
        <Link
          to="/blog"
          className="inline-flex items-center px-5 py-2.5 sm:px-6 sm:py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors text-sm sm:text-base"
          style={{ backgroundColor: 'var(--primary-color)' }}
        >
          <FaArrowLeft className="mr-2" />

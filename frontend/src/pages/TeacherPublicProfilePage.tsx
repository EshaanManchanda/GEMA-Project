...
const TeacherPublicProfilePage: React.FC = () => {
  ...
  const coreValues = DEFAULT_PHILOSOPHY;
    ...
    <div className="min-h-screen bg-[#f4f5f9] font-sans overflow-x-hidden">
      ...
      <section className="relative h-[420px] overflow-hidden pt-10 pb-20">
        {cover
          ...
          : <img src="/assets/defbanner.png" alt="Banner" className="absolute inset-0 w-full h-full object-cover object-center" />
        }
          ...
          <div className="flex flex-wrap items-center gap-8 sm:gap-10 pb-4">
            ...
            <div className="flex-1 min-w-0 pb-1">
              <div className="flex flex-wrap items-center gap-3 mb-2">
                <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-white leading-tight drop-shadow-md">{teacherName}</h1>
                {isVerified ? (
                  ...
                  <span className="inline-flex items-center gap-1.5 text-xs font-bold px-3.5 py-1 rounded-full bg-emerald-500/20 border border-emerald-400/30 text-emerald-50 backdrop-blur-md shadow-[0_0_15px_rgba(16,185,129,0.3)] mt-2 sm:mt-0">
                    <FaGraduationCap className="text-emerald-400 text-[12px]" />
                    Educator
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-wrap items-center mt-2 text-sm text-white/90 mb-4">
                ...
                <span className="flex items-center gap-1.5 text-sm text-white/80">
                  <FaUsers className="text-white/60 text-base" /> {compactNumber(totalStudents)} Students
                </span>
              </div>
            ...
            <div className={`bg-white rounded-3xl p-8 border border-slate-100 shadow-sm flex flex-col ${!teacherVideoUrl ? 'md:col-span-2' : ''}`}>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mt-auto">
                ...
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 flex flex-col justify-center items-center text-center">
                  ...
                  <p className="text-sm font-bold text-slate-700">{teacher.languagesSpoken?.length ? teacher.languagesSpoken.join(', ') : 'Not specified'}</p>
                </div>
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 flex flex-col justify-center items-center text-center">
                  <div className="flex items-center gap-2 mb-1">
                    <FaStar className="text-amber-400" />
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Teaching Style</span>
                  </div>
                ...
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 flex flex-col justify-center items-center text-center">
                  ...
                  <p className="text-sm font-bold text-slate-700 truncate">{(teacher as any).location || (teacher as any).city || 'Online / Flexible'}</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            <div className="lg:col-span-3 bg-[#f5f3ff] rounded-3xl p-8 flex flex-col border border-indigo-50/50">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-2xl font-black text-[#1e293b]">What You'll Gain</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 flex-grow">
                {[
                  { icon: <FaCheckCircle/>, text: 'Solve problems from first principles' },
                  { icon: <FaStar/>, text: 'Build exam confidence' },
                  { icon: <FaUsers/>, text: 'Active class participation' },
                  { icon: <FaBookOpen/>, text: 'Master core concepts deeply' },
                ].map((item, i) => (
            ...
            <div className="lg:col-span-2 bg-[#ecfdf5] rounded-3xl p-8 flex flex-col border border-emerald-50/50">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-[#64748b] font-medium mt-1 text-sm">Check when this educator is available for classes.</p>
                </div>
              </div>
            ...
            <div className="relative z-10 flex flex-col gap-16">
                  ...
                  <div className="relative flex flex-col items-center mb-12">
                    <div className="text-center">
                      ...
                      <p className="text-slate-500 text-lg max-w-xl mx-auto">
                        Discover classes taught by this educator.
                      </p>
                    </div>
                    <div className="mt-6 sm:mt-0 sm:absolute sm:right-0 sm:bottom-0">
                      <Link to={`/search?organizer=${data?.teacher?._id || id}`} className="inline-flex items-center px-6 py-2.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold rounded-full transition-colors text-center shadow-sm border border-indigo-100">
                        View all classes →
                      </Link>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {classCards.map((event) => {
                  ...
                  const grades = event.grades && event.grades.length > 0 ? event.grades.join(', ') : 'All Grades';
                ...
                <div className="relative z-10 py-4">
                  <div className="max-w-4xl mx-auto relative z-10">
                    <div className="text-center mb-12">
                      ...
                      <p className="text-slate-500 text-lg max-w-xl mx-auto">
                        Everything you need to know about learning with {teacherName}.
                      </p>
                    </div>
              ...
              <div className="relative z-10 py-4">
                <div className="text-center mb-12">
                  ...
                  <p className="text-slate-500 text-lg max-w-xl mx-auto">
                    Read real feedback from students and parents.
                  </p>
                </div>

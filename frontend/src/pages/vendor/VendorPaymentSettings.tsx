  ...
  useEffect(() => {
    if (paymentSettings) {
      setFormData({
        ...
        stripeAccountId: (paymentSettings as any).stripeAccountId || '',
        stripePublishableKey: (paymentSettings as any).stripePublishableKey || '',
        stripeSecretKey: ''
      });
    }
  }, [paymentSettings]);
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            {(paymentSettings as any)?.hasCustomStripeAccount && (paymentSettings as any)?.subscriptionActive ? (
              <div>
                ...
                <p className="text-gray-700">
                  You're using your own Stripe payment gateway. Monthly subscription: {(paymentSettings as any)?.subscriptionAmount} {(paymentSettings as any)?.hasCustomStripeAccount ? 'AED' : ''}
                </p>
                <p className="text-sm text-gray-600 mt-2">
                  Subscription valid until: {(paymentSettings as any)?.subscriptionPaidUntil ? new Date((paymentSettings as any).subscriptionPaidUntil).toLocaleDateString() : 'N/A'}
                </p>
              </div>
            ) : (
              <div>
            ...
            <div className="px-6 py-5 border-t border-gray-200">
              <div className="flex space-x-4 border-b border-gray-200 mb-6">
                <button
                  ...
                  className={`py-2 px-4 font-medium ${activeTab === 'bank'
                ...
                <button
                  ...
                  className={`py-2 px-4 font-medium ${activeTab === 'stripe'
                    ? 'border-b-2 border-orange-600 text-orange-600'
                    : 'text-gray-600 hover:text-gray-900'
                    }`}
                >

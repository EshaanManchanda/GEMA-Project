...
export default function AiArtCompetitionPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0E1525] text-slate-350 font-sans selection:bg-amber-500 selection:text-slate-950 relative overflow-x-hidden">
      ...
      <div id="partnerships" className="py-24 border-y border-slate-700/30 relative overflow-hidden bg-[#0A0F1A]">
        {/* Decorative Background Elements */}
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[80%] rounded-full bg-purple-400/15 blur-[150px] pointer-events-none" />
        <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[80%] rounded-full bg-blue-500/15 blur-[150px] pointer-events-none" />

        <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
            Become a <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 drop-shadow-[0_0_15px_rgba(56,189,248,0.2)]">Sponsor</span>
          </h2>
          <p className="text-slate-400 max-w-2xl mx-auto text-lg md:text-xl mb-10 leading-relaxed">
            We invite schools, universities, and businesses to empower the next generation of AI creators through meaningful sponsorships.
          </p>
          <Link
            to="/ai-art-competition/sponsorship"
            className="inline-flex items-center gap-3 px-10 py-4 bg-white hover:bg-slate-200 text-slate-900 font-bold text-lg rounded-full transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:scale-105 active:scale-95"
          >
            Explore Sponsorship Options <FiChevronRight className="stroke-[3] text-xl" />
          </Link>
        </div>
      </div>

...
export default function AiArtCompetitionPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0E1525] text-slate-350 font-sans selection:bg-amber-500 selection:text-slate-950 relative overflow-x-hidden">
      ...
      <div id="partnerships" className="py-24 bg-[#0B101D] border-b border-slate-700/30 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[50%] h-[50%] rounded-full bg-purple-500/5 blur-[150px] pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[50%] h-[50%] rounded-full bg-blue-500/5 blur-[150px] pointer-events-none" />

        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center border border-purple-500/50 text-purple-400 font-extrabold px-4 py-1.5 rounded-full text-[10px] uppercase tracking-[0.16em] mb-4 bg-purple-500/10">
              Partnership & Sponsorship
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
              Empowering the Next Generation of <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">AI Creators</span>
            </h2>
            <p className="text-slate-300 max-w-3xl mx-auto text-base leading-relaxed mb-8">
              The KidRove AI Art Competition — “If AI Could Draw My UAE…” brings together students from across the UAE and beyond to explore Artificial Intelligence, creativity, imagination and the future of the UAE.
              <br /><br />
              We invite schools, universities and businesses to become part of this initiative through meaningful partnerships that create real value for students.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8">
              <div className="flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 rounded-2xl">
                <span className="text-2xl">🏫</span>
                <div className="text-left">
                  <span className="block text-sm font-bold text-white">Schools</span>
                  <span className="block text-xs text-slate-400">Learn. Create. Compete.</span>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 rounded-2xl">
                <span className="text-2xl">🎓</span>
                <div className="text-left">
                  <span className="block text-sm font-bold text-white">Universities</span>
                  <span className="block text-xs text-slate-400">Engage. Inspire. Connect.</span>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 rounded-2xl">
                <span className="text-2xl">💼</span>
                <div className="text-left">
                  <span className="block text-sm font-bold text-white">Corporates</span>
                  <span className="block text-xs text-slate-400">Support. Empower. Impact.</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-900/20 to-indigo-900/10 border border-blue-500/30 rounded-3xl p-8 relative overflow-hidden group hover:-translate-y-1 transition-transform">
              <div className="absolute top-0 right-0 p-4">
                <span className="bg-blue-500/20 text-blue-300 text-[10px] font-bold px-3 py-1 rounded-full border border-blue-500/30">1 per Emirate</span>
              </div>
              <div className="text-4xl mb-4">🏫</div>
              <h3 className="text-2xl font-black text-white mb-2">Official Partner School</h3>
              <div className="text-blue-400 font-bold mb-6">AED 3,000</div>
              <ul className="space-y-3 text-sm text-slate-300">
                <li className="flex gap-3 items-start"><FiCheck className="text-blue-400 mt-1 shrink-0" /> Up to 100 complimentary student registrations</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-blue-400 mt-1 shrink-0" /> FREE 2-hour live AI & Generative AI workshop</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-blue-400 mt-1 shrink-0" /> One Million Prompters learning guidance</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-blue-400 mt-1 shrink-0" /> Partner School recognition for the Emirate</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-blue-400 mt-1 shrink-0" /> Student participation certificates and awards</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-blue-400 mt-1 shrink-0" /> Opportunity for student artwork to be showcased</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-blue-400 mt-1 shrink-0" /> Website and selected competition communications recognition</li>
              </ul>
            </div>

            {/* University Partner */}
            <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/10 border border-purple-500/30 rounded-3xl p-8 relative overflow-hidden group hover:-translate-y-1 transition-transform">
              <div className="absolute top-0 right-0 p-4">
                <span className="bg-purple-500/20 text-purple-300 text-[10px] font-bold px-3 py-1 rounded-full border border-purple-500/30">2 available</span>
              </div>
              <div className="text-4xl mb-4">🎓</div>
              <h3 className="text-2xl font-black text-white mb-2">University Partner</h3>
              <div className="text-purple-400 font-bold mb-6">AED 10,000</div>
              <ul className="space-y-3 text-sm text-slate-300">
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> Official University Partner recognition</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> University branding on the competition website</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> AI & Future Careers webinar</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> University faculty speaker/representative</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> Opportunity for faculty participation in judging/mentoring</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> University-sponsored student award</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> Opportunity to interact with selected finalists/winners through KidRove-managed sessions</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> Opportunity for a university campus experience</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> Website and social media visibility</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> Closing ceremony recognition</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-purple-400 mt-1 shrink-0" /> Post-event impact report</li>
              </ul>
            </div>

            {/* Young Creators Showcase Partner */}
            <div className="bg-gradient-to-br from-emerald-900/20 to-teal-900/10 border border-emerald-500/30 rounded-3xl p-8 relative overflow-hidden group hover:-translate-y-1 transition-transform">
              <div className="absolute top-0 right-0 p-4">
                <span className="bg-emerald-500/20 text-emerald-300 text-[10px] font-bold px-3 py-1 rounded-full border border-emerald-500/30">1 available</span>
              </div>
              <div className="text-4xl mb-4">🌐</div>
              <h3 className="text-2xl font-black text-white mb-2">Young Creators Showcase Partner</h3>
              <div className="text-emerald-400 font-bold mb-6">AED 10,000</div>
              <ul className="space-y-3 text-sm text-slate-300">
                <li className="flex gap-3 items-start"><FiCheck className="text-emerald-400 mt-1 shrink-0" /> Official Young Creators Showcase Partner status</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-emerald-400 mt-1 shrink-0" /> Brand association with the KidRove Student AI Art Showcase</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-emerald-400 mt-1 shrink-0" /> Branding on the digital showcase/gallery</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-emerald-400 mt-1 shrink-0" /> Association with selected student artworks</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-emerald-400 mt-1 shrink-0" /> Website and competition visibility</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-emerald-400 mt-1 shrink-0" /> Social media recognition</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-emerald-400 mt-1 shrink-0" /> Closing ceremony recognition</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-emerald-400 mt-1 shrink-0" /> Post-event partner recognition</li>
              </ul>
            </div>

            {/* Future Creators Recognition Partner */}
            <div className="bg-gradient-to-br from-amber-900/20 to-orange-900/10 border border-amber-500/30 rounded-3xl p-8 relative overflow-hidden group hover:-translate-y-1 transition-transform">
              <div className="absolute top-0 right-0 p-4">
                <span className="bg-amber-500/20 text-amber-300 text-[10px] font-bold px-3 py-1 rounded-full border border-amber-500/30">4 available</span>
              </div>
              <div className="text-4xl mb-4">🏅</div>
              <h3 className="text-2xl font-black text-white mb-2">Future Creators Recognition Partner</h3>
              <div className="text-amber-400 font-bold mb-6">AED 7,500</div>
              <ul className="space-y-3 text-sm text-slate-300">
                <li className="flex gap-3 items-start"><FiCheck className="text-amber-400 mt-1 shrink-0" /> Gold Partner branding</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-amber-400 mt-1 shrink-0" /> Dedicated Future Creators Award or a relevant themed award</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-amber-400 mt-1 shrink-0" /> Student AI/creativity workshop</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-amber-400 mt-1 shrink-0" /> Company representative participation</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-amber-400 mt-1 shrink-0" /> "Award presented by [Company]" recognition</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-amber-400 mt-1 shrink-0" /> Website and social media visibility</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-amber-400 mt-1 shrink-0" /> Closing ceremony recognition</li>
                <li className="flex gap-3 items-start"><FiCheck className="text-amber-400 mt-1 shrink-0" /> Post-event impact report</li>
              </ul>
            </div>
          ...
          {/* Partnership CTA */}
          <div className="mt-12 bg-white/5 border border-white/10 rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 max-w-5xl mx-auto">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-1.5">Become a Partner</h3>
                <p className="text-slate-400 text-sm">Connect with us on WhatsApp to discuss sponsorship opportunities.</p>
              </div>
            </div>
            <a
            ...
            >
              Message us on WhatsApp <FiChevronRight className="stroke-[3] text-lg" />
            </a>
          </div>
        </div>
      </div>

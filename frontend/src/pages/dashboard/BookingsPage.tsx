            ...
            <div className="p-6">
              {filteredBookings.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <div className="mt-6">
                    <Link to="/search" className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                          ...
                          <div className="p-4 sm:p-6 sm:w-2/3 md:w-3/4">
                            <div className="flex flex-col sm:flex-row justify-between">
                              <div>
                                ...
                                <div className="text-sm text-gray-500 mb-4">
                                  ...
                                  <p><span className="font-medium">Total Amount:</span> {
                                    booking.paymentStatus === 'free' || booking.paymentMethod === 'free' || booking.total === 0
                                      ? 'Free'
                              ...
                              <div className="mt-4 sm:mt-0 flex flex-col space-y-2">
                                <Link
                                  to={`/bookings/${event.slug || booking._id || booking.id}`}

...
const AdminAnnouncementsPage: React.FC = () => {
  ...
  const handleSubmitForm = async (data: CreateAnnouncementBarData) => {
    try {
      console.log('[AdminAnnouncementsPage] Received form data:', {
        status: data.status,
      ...
      if (selectedAnnouncement?._id) {
        console.log('[AdminAnnouncementsPage] Updating announcement:', selectedAnnouncement._id);
        await announcementBarAPI.admin.updateAnnouncement(selectedAnnouncement._id, data);
        toast.success('Announcement updated successfully');
      } else {
        console.log('[AdminAnnouncementsPage] Creating new announcement');
      ...
      console.error('[AdminAnnouncementsPage] Error:', error);

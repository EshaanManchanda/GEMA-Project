...
const AdminEventsPage: React.FC = () => {
  ...
  const filteredEvents = useMemo(() => {
    ...
    if (venueTypeFilter !== 'all') {
      filtered = filtered.filter(e => e.venueType?.toLowerCase() === venueTypeFilter.toLowerCase());
    }

    return filtered;
  }, [events, searchTerm, statusFilter, categoryFilter, typeFilter, featuredFilter, venueTypeFilter]);
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow mb-6 p-6">
            ...
            {/* Second row for Category and Venue Type filter */}

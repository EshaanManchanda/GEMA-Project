                          ...
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              ...
                              <div className="text-sm text-gray-500">
                                  {teachingEvent.eventType || teachingEvent.venueType || 'Offline'} • {teachingEvent.location.city}
                              </div>
                            </div>
                          </div>
                        </td>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-purple-100 text-purple-800">
                    {selectedTeachingEvent.eventType || selectedTeachingEvent.venueType || 'Offline'}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{selectedTeachingEvent.eventType || selectedTeachingEvent.venueType || 'Offline'}</p>
                  </div>

              ...
              <div className="space-y-6">
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div>
                      <p className="text-sm font-medium text-gray-700">Site Animations</p>
                      <p className="text-xs text-gray-500 mt-0.5">
                        Enable smooth transitions and motion effects site-wide
                      </p>
                    </div>
                    <button
                      type="button"
                      role="switch"
                      aria-checked={systemSettings.animationsEnabled}
                      onClick={() =>
                        setSystemSettings(prev => ({
                          ...prev,
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ${
                        systemSettings.animationsEnabled ? 'bg-primary' : 'bg-gray-200'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform ${
                          systemSettings.animationsEnabled ? 'translate-x-6' : 'translate-x-1'
                        }`}
                      />
                    </button>
                  </div>

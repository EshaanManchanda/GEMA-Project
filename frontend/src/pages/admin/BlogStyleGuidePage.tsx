      ...
      items: [
        {
          ...
          code: `<a href="#" class="blog-button">Click Here</a>`,
          preview: (
            <a href="#" className="blog-button">Click Here</a>
          )
        },
        {
          label: 'Outline Button',
          className: 'blog-button-outline',
          code: `<a href="#" class="blog-button-outline">Learn More</a>`,
          preview: (
            <a href="#" className="blog-button-outline">Learn More</a>
          )
        }
      ]
    },

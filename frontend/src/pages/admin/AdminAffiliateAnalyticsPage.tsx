...
const AdminAffiliateAnalyticsPage: React.FC = () => {
  ...
  const fetchAnalytics = async () => {
    ...
    try {
      ...
      logger.error('Error fetching affiliate analytics:', err);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 flex gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-md font-medium transition ${timeRange === '7days'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md font-medium transition ${timeRange === '30days'
                ? 'bg-orange-600 text-white'
                : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md font-medium transition ${timeRange === '90days'
                ? 'bg-orange-600 text-white'
                : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50'
              }`}
          >

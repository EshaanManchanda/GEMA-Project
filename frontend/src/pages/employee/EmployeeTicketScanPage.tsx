...
import { QrCode, Users, CheckCircle, XCircle, Clock, Filter } from 'lucide-react';

// Lazy load QRCodeScanner (~400KB due to qr-scanner library) - only loaded when scanner opened
const QRCodeScanner = lazy(() => import('../../components/employee/QRCodeScanner'));
...
const EmployeeTicketScanPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* QR Code Scanner Modal - lazy loaded */}
      {isScannerOpen && (
        <Suspense fallback={

...
export const updateVendorProfile = createAsyncThunk(
  ...
  async (profileData: Partial<VendorProfile>, { rejectWithValue }) => {
    try {
      const response = await vendorAPI.updateVendorProfile(profileData);
...
export const submitVendorApplication = createAsyncThunk(
  ...
  async (applicationData: VendorState['applicationData'], { rejectWithValue }) => {
    try {
      const response = await vendorAPI.applyForVendor(applicationData!);
...
export const fetchVendorStats = createAsyncThunk(
  ...
  async (_period: 'week' | 'month' | 'year' = 'month', { rejectWithValue }) => {
    try {
...
export const fetchVendorNotifications = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await (vendorAPI as any).getNotifications();
      return response;
    } catch (error: any) {
...
export const markNotificationAsRead = createAsyncThunk(
  ...
  async (notificationId: string, { rejectWithValue }) => {
    try {
      await (vendorAPI as any).markNotificationAsRead(notificationId);
...
export const markAllNotificationsAsRead = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      await (vendorAPI as any).markAllNotificationsAsRead();
...
export const fetchVendorPayouts = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await (vendorAPI as any).getPayouts();
      return response;
    } catch (error: any) {
...
export const requestPayout = createAsyncThunk(
  ...
  async (amount: number, { rejectWithValue }) => {
    try {
      const response = await (vendorAPI as any).requestPayout(amount);
...
export const updateEventStatus = createAsyncThunk(
  ...
  async (params: {
    ...
    try {
      const response = await (vendorAPI as any).updateEventStatus(params.eventId, params.status);
...
export const updateBookingStatus = createAsyncThunk(
  ...
  async (params: {
    ...
    try {
      const response = await (vendorAPI as any).updateBookingStatus(params.bookingId, params.status);
...
export const selectVendorEventById = (id: string) => (state: { vendor: VendorState }) => {
  return state.vendor.events.find(event => event._id === id);
};
...
export const selectVendorUpcomingEvents = (state: { vendor: VendorState }) => {
  ...
  return state.vendor.events.filter(event => {
    const eventDate = new Date((event.dateSchedule?.[0] as any)?.startDate || (event.dateSchedule?.[0] as any)?.date || 0);

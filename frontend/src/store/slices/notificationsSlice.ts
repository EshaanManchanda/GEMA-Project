...
export const markAsUnread = createAsyncThunk(
  ...
  async (id: string, { rejectWithValue }) => {
    try {
      const response = await (notificationAPI as any).markAsUnread(id);
      return response.data || response;
    } catch (error: any) {
...
export const deleteAllRead = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await (notificationAPI as any).deleteAllRead();
...
export const sendNotification = createAsyncThunk(
  ...
  async (params: {
    ...
    try {
      const response = await (notificationAPI as any).sendNotification(params.id, params.channels);
...
export const scheduleNotification = createAsyncThunk(
  ...
  async (params: {
    ...
    try {
      const response = await (notificationAPI as any).scheduleNotification(params.id, params.scheduledAt);
...
export const cancelScheduledNotification = createAsyncThunk(
  ...
  async (id: string, { rejectWithValue }) => {
    try {
      const response = await (notificationAPI as any).cancelScheduledNotification(id);
...
export const bulkAction = createAsyncThunk(
  ...
  async (params: {
    ...
    try {
      await (notificationAPI as any).bulkAction(params.notificationIds, params.action);

...
export const performSearch = createAsyncThunk(
  ...
  async (params: {
    ...
    try {
      const response = await (searchAPI as any).search(params);
      return response;
    } catch (error: any) {
...
export const getPopularSearches = createAsyncThunk(
  ...
  async (limit: number = 10, { rejectWithValue }) => {
    try {
      const response = await (searchAPI as any).getPopularSearches(limit);
      return response;
    } catch (error: any) {
...
export const saveSearch = createAsyncThunk(
  ...
  async (params: {
    ...
    try {
      const response = await (searchAPI as any).saveSearch(params);
...
export const getSavedSearches = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await (searchAPI as any).getSavedSearches();
      return response;
    } catch (error: any) {
...
export const deleteSavedSearch = createAsyncThunk(
  ...
  async (id: string, { rejectWithValue }) => {
    try {
      await (searchAPI as any).deleteSavedSearch(id);
...
export const getSearchHistory = createAsyncThunk(
  ...
  async (limit: number = 20, { rejectWithValue }) => {
    try {
      const response = await (searchAPI as any).getSearchHistory(limit);
      return response;
    } catch (error: any) {
...
export const clearSearchHistory = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      await (searchAPI as any).clearSearchHistory();
...
export const selectSearchSummary = (state: { search: SearchState }) => {
  const { currentQuery, results } = state.search;

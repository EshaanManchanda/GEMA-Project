...
export class NewsletterService {
  ...
  async createSubscription(
    ...
    try {
      ...
      logger.error("=== NEWSLETTER SERVICE ERROR (CREATE) ===");
  ...
  async updateSubscription(
    ...
    try {
      ...
      logger.error("=== NEWSLETTER SERVICE ERROR (UPDATE) ===");
      logger.error("Error:", error.message);
  ...
  async getSubscriptionByEmail(
    ...
    try {
      ...
      logger.error("=== NEWSLETTER SERVICE ERROR (GET BY EMAIL) ===");
      logger.error("Error:", error.message);
  ...
  async getSubscriptionStats(): Promise<any> {
    try {
      ...
      logger.error("=== NEWSLETTER SERVICE ERROR (GET STATS) ===");
      logger.error("Error:", error.message);
  ...
  async updateLastEmailSent(subscriberIds: string[]): Promise<void> {
    try {
      ...
      logger.error("=== NEWSLETTER SERVICE ERROR (UPDATE LAST EMAIL) ===");
      logger.error("Error:", error.message);

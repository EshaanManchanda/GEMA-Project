import { Event, Vendor, Venue, Review, Order, Booking, Category } from '../models/index';
...
class StatsService {
  ...
  async getPublicStats(): Promise<PublicStats> {
    ...
    const [
      ...
      Event.aggregate([
        { $match: { isDeleted: false, isApproved: true, status: 'published', 'location.city': { $exists: true, $ne: null } } },

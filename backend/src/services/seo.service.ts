  ...
  async generateSitemap(domain?: string): Promise<string> {
    ...
    try {
      ...
      const staticPages = [
        ...
        { url: "/best-activities-for-kids", priority: 0.9, changefreq: "daily" },
        { url: "/age-appropriate-experiences", priority: 0.8, changefreq: "weekly" },
        { url: "/educational-workshops", priority: 0.8, changefreq: "weekly" },
        { url: "/outdoor-activities-for-children", priority: 0.8, changefreq: "weekly" },
        { url: "/family-friendly-adventures", priority: 0.8, changefreq: "weekly" },
        { url: "/seasonal-events-for-kids", priority: 0.8, changefreq: "daily" },

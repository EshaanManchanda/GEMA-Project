...
export const initializeFirebase = (): void => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.warn('⚠ Firebase credentials not found, using Application Default Credentials');
    ...
    throw new Error('Firebase configuration missing. Please set Firebase environment variables.');
  } catch (error) {

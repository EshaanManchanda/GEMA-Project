...
export class RedisPool {
  ...
  async initialize(): Promise<void> {
    ...
    logger.info(`${this.poolName}: Initializing with ${this.poolSize} connections...`);
    ...
    logger.info(`${this.poolName}: Initialized successfully with ${this.pool.length} connections`);
  }

...
export const submitPartnershipValidation = [
  ...
  body('website')
    ...
    .withMessage('Please provide a valid website URL (must start with http:// or https://)'),
...
export const getAllPartnershipsValidation = [
  ...
  query('status')
    ...
    .withMessage('Status must be one of: pending, contacted, approved, rejected'),

  query('partnershipType')
    .optional()
    .isIn(['vendor', 'influencer', 'school', 'affiliate', 'other'])
    .withMessage('Partnership type must be one of: vendor, influencer, school, affiliate, other'),
...
export const getPartnershipByIdValidation = [
  param('id')
    .isMongoId()
    .withMessage('Invalid partnership ID')
];

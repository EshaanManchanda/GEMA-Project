...
const applyAffiliateValidation = [
  ...
  body('paymentMethod')
    ...
    .withMessage('Payment method must be bank_transfer, paypal, stripe, or wallet'),
  body('paymentDetails')
    .isObject()
  ...
  body('payoutFrequency')
    ...
    .withMessage('Payout frequency must be weekly, bi_weekly, monthly, or quarterly'),
  body('socialMedia')
    .optional()
    .isObject()
...
// Public routes
router.post('/click/:affiliateCode', 

...
import {
  ...
  updateSEOContent,
  deleteSEOContent
} from '../controllers/seoContent.controller';
...
// Public routes
router.get('/:page', getSEOContentValidation, validateRequest, getPublicSEOContent);
...
router.put('/:page', updateSEOContentValidation, validateRequest, updateSEOContent);
router.delete('/:page', deleteSEOContentValidation, validateRequest, deleteSEOContent);

...
router.post('/:id/impression', getPopupValidation, validateRequest, recordImpression);
router.post('/:id/click', getPopupValidation, validateRequest, recordClick);
router.post('/:id/dismiss', getPopupValidation, validateRequest, recordDismissal);

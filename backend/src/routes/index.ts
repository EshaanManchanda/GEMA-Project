...
import adminBusinessReportRoutes from "./admin.businessReport.routes";
...
// Admin Business Optimization / Report Center routes (KBOS Phase 1)
router.use("/admin/business-reports", adminBusinessReportRoutes);

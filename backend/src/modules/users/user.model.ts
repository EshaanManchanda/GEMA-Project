    ...
    phone: {
      ...
      validate: {
        validator: function (v: string) {
          ...
          return (
            internationalFormat.test(cleaned) || nationalFormat.test(cleaned)
          );
        },
        message:
          "Phone must be a valid phone number (8-15 digits, optionally with + prefix)",
      },
    },
    avatar: {
      type: String,

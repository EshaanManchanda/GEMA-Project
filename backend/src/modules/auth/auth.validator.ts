...
import { validateEmail, validatePhone } from "../../validators/common.validator";
...
export const validateRegistration = [
  ...
  body("role")
    .optional()
    .isIn(["customer", "vendor", "employee", "teacher"])
    .withMessage("Role must be customer, vendor, employee, or teacher"),
];
 ...
 */
export const validateForgotPassword = [validateEmail("email", true)];
 ...
 */
export const validateResendVerification = [validateEmail("email", true)];

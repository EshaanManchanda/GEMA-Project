...
import { Teacher, TeacherSubscription, TeacherSubscriptionPlan, TeacherBillingCycle, TeacherSubscriptionStatus } from "../../models/index";
...
class TeacherSubscriptionService implements ITeacherSubscriptionService {
  ...
  async processSubscriptionPayment(
    ...
    try {
      ...
      console.error("Error processing teacher subscription payment:", error);
  ...
  async suspendSubscription(
    ...
    try {
      ...
      console.error("Error suspending teacher subscription:", error);
  ...
  async reactivateSubscription(teacherId: Types.ObjectId): Promise<void> {
    try {
      ...
      console.log(`✓ Reactivated subscription for teacher ${teacherId}`);
    } catch (error: any) {
      console.error("Error reactivating teacher subscription:", error);
...
<p><a href="${process.env.FRONTEND_URL}/teacher/subscription">Renew subscription</a></p>`,
  ...
  async processExpiredSubscriptions(): Promise<void> {
    try {
      ...
      console.log("✓ Processed expired teacher subscriptions");
    } catch (error: any) {
      console.error("Error processing expired teacher subscriptions:", error);
      throw new Error(

...
describe('CollectionSyncService', () => {
  ...
  describe('reconcileAll', () => {
    ...
    it('should continue on individual collection failure', async () => {
      ...
      jest.spyOn(collectionSyncService, 'syncCollection')
    ...
    it('should throw on MongoDB connection failure', async () => {
      ...
      await expect(collectionSyncService.reconcileAll())
  ...
  describe('syncCollection', () => {
    it('should fetch events in parallel batches', async () => {
      ...
      const getEventSpy = jest.spyOn(collectionSyncService as any, 'getEventDataForEmbed')
        .mockResolvedValue({
    ...
    it('should return null if collection not found', async () => {
      ...
      const result = await collectionSyncService.syncCollection('507f1f77bcf86cd799439011');

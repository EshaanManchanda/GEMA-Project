 ...
 * @access Public
 */
export const getActivePopups = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const popups = await popupService.getActivePopups(userContext, currentRoute);
 ...
 */
export const getAllPopups = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const filters = {
 ...
 * @access Private (Admin only)
 */
export const getPopupById = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
 ...
 * @access Private (Admin only)
 */
export const createPopup = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
 ...
 * @access Private (Admin only)
 */
export const updatePopup = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
 ...
 * @access Private (Admin only)
 */
export const deletePopup = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {

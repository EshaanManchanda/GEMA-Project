...
export const initiateStripeConnect = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error initiating Stripe Connect:", error);
    res.status(500).json({
...
export const refreshStripeConnectLink = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error refreshing Stripe Connect link:", error);
    res.status(500).json({
...
export const disconnectStripeConnect = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error disconnecting Stripe Connect:", error);
    res.status(500).json({
...
export const updateStripeKeys = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error updating Stripe keys:", error);
    res
      .status(500)
...
export const switchPaymentMode = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error switching payment mode:", error);
    res
      .status(500)
...
export const calculateCommissionComparison = async (
  ...
  try {
    ...
    logger.error("Error calculating commission comparison:", error);
    res.status(500).json({

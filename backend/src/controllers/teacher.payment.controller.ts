...
export const getTeacherPaymentOverview = async (
  ...
  try {
    ...
    logger.error("Error getting teacher payment overview:", error);
    res.status(500).json({
...
export const initiateTeacherStripeConnect = async (
  ...
  try {
    ...
    logger.error("Error initiating Stripe Connect (teacher):", error);
    res.status(500).json({
...
export const getTeacherStripeConnectStatus = async (
  ...
  try {
    ...
    logger.error("Error getting Stripe Connect status (teacher):", error);
    res.status(500).json({
...
export const refreshTeacherStripeConnectLink = async (
  ...
  try {
    ...
    logger.error("Error refreshing Stripe Connect link (teacher):", error);
    res.status(500).json({
...
export const disconnectTeacherStripeConnect = async (
  ...
  try {
    ...
    logger.error("Error disconnecting Stripe Connect (teacher):", error);
    res.status(500).json({
...
export const updateTeacherStripeKey = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error updating teacher Stripe key:", error);
    res.status(500).json({
...
export const switchTeacherPaymentMode = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error switching teacher payment mode:", error);
    res.status(500).json({
...
export const getTeacherSubscriptionInfo = async (
  ...
  try {
    ...
    logger.error("Error getting teacher subscription info:", error);
    res.status(500).json({
...
export const payTeacherSubscription = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error processing teacher subscription:", error);
    res.status(500).json({
...
export const updateTeacherBankAccount = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error updating teacher bank account:", error);
    res.status(500).json({
...
export const updateTeacherPayoutPreferences = async (
  ...
  try {
    ...
    logger.error("Error updating teacher payout preferences:", error);
    res.status(500).json({
...
export const calculateTeacherCommissionComparison = async (
  ...
  try {
    ...
    logger.error("Error calculating teacher commission comparison:", error);
    res.status(500).json({

...
export const getActiveAnnouncements = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const announcements = await announcementBarService.getActiveAnnouncements(currentRoute);
 ...
 * @access Public
 */
export const recordDismissal = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getAnnouncementById = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const announcement = await announcementBarService.getAnnouncementById(req.params.id);
...
export const createAnnouncement = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    console.log('[createAnnouncement] Received body:', {
    ...
    const announcement = await announcementBarService.createAnnouncement(req.body, userId);

    console.log('[createAnnouncement] Created announcement status:', announcement.status);
...
export const updateAnnouncement = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    console.log('[updateAnnouncement] Received body:', {
      status: req.body.status,
      isActive: req.body.isActive,
      fullBody: req.body
    });

    const announcement = await announcementBarService.updateAnnouncement(req.params.id, req.body);

    console.log('[updateAnnouncement] Updated announcement status:', announcement?.status);
 ...
 * @access Private (Admin only)
 */
export const updateDisplayOrders = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {

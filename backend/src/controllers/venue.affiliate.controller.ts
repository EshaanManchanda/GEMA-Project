...
export const claimAffiliateVenue = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error claiming affiliate venue:", error);
    res
      .status(500)
...
export const getClaimedVenues = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error fetching claimed venues:", error);
    res
      .status(500)
...
export const getVenueAffiliateAnalytics = async (
  ...
  try {
    ...
    logger.error("Error fetching venue affiliate analytics:", error);
    res
      .status(500)
...
export const getVenueAnalytics = async (req: Request, res: Response) => {
  try {
    ...
    logger.error("Error fetching venue analytics:", error);
    res.status(500).json({

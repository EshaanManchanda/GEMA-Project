...
async function migrateBrandConfig() {
  ...
  - Contact Email: ${brand.contactEmail}\n`);
    ...
    if (emailSettingsCount > 0) {
      ...
      console.log(`  ✓ Updated ${emailResult.modifiedCount} EmailSettings documents`);
    } else {
      console.log('  ℹ No EmailSettings documents found with "gema" references');
    }
    ...
    if (revenueSettingsCount > 0) {
      ...
      console.log(`  ✓ Updated ${revenueResult.modifiedCount} AdminRevenueSettings documents`);
    } else {
      console.log('  ℹ No AdminRevenueSettings documents found with "gema" references');
    }

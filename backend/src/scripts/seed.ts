...
const sampleVenues = [
  {
    ...
    description: 'A world-class performing arts venue in the heart of Downtown Dubai',
    ...
    facilities: ['Air Conditioning', 'Sound System', 'Lighting', 'Parking', 'VIP Lounge'],
    operatingHours: [
    ...
    checkInGates: [
      { gateName: 'Main Entrance', gateCode: 'GATE01', isActive: true, description: 'Primary entrance for general admission' },
      { gateName: 'VIP Entrance', gateCode: 'GATE02', isActive: true, description: 'Exclusive entrance for VIP guests' }
    ],
  ...
  },
  {
    ...
    facilities: ['360° Projection', 'Climate Control', 'Multiple Entrances', 'Food Courts', 'Metro Access'],
    operatingHours: [
      { day: 'monday', openTime: '08:00', closeTime: '23:59', isClosed: false },
      { day: 'tuesday', openTime: '08:00', closeTime: '23:59', isClosed: false },
      { day: 'wednesday', openTime: '08:00', closeTime: '23:59', isClosed: false },
      { day: 'thursday', openTime: '08:00', closeTime: '23:59', isClosed: false },
      { day: 'friday', openTime: '08:00', closeTime: '23:59', isClosed: false },
      { day: 'saturday', openTime: '08:00', closeTime: '23:59', isClosed: false },
      { day: 'sunday', openTime: '08:00', closeTime: '23:59', isClosed: false }
    ],
    checkInGates: [
      { gateName: 'North Gate', gateCode: 'GATE03', isActive: true, description: 'North entrance' },
      { gateName: 'South Gate', gateCode: 'GATE04', isActive: true, description: 'South entrance' }
    ],
    baseRentalPrice: 25000,
    currency: 'AED',
    totalEvents: 0
  },
  {
    ...
    facilities: ['Beach Access', 'Palm Trees', 'Sunset Views', 'Parking', 'Restrooms'],
    operatingHours: [
    ...
    checkInGates: [
      { gateName: 'Beach Gate', gateCode: 'GATE05', isActive: true, description: 'Main beach entrance' }
    ],
  ...
  {
    name: 'Madinat Jumeirah Conference Centre',
    description: 'Premium conference facility with traditional Arabian architecture',
    status: VenueStatus.ACTIVE,
    address: {
      street: 'Al Sufouh Road, Madinat Jumeirah',
      city: 'Dubai',
      state: 'Dubai',
      country: 'UAE',
      zipCode: '24578'
    ...
    capacity: 1200,
    venueType: VenueType.INDOOR,
    facilities: ['Conference Rooms', 'Translation Services', 'Catering', 'Business Center', 'WiFi'],
    operatingHours: [
    ...
    checkInGates: [
      { gateName: 'Main Reception', gateCode: 'GATE06', isActive: true, description: 'Main conference entrance' },
      { gateName: 'Executive Entrance', gateCode: 'GATE07', isActive: true, description: 'VIP and executive entrance' }
    ],
    baseRentalPrice: 12000,
    currency: 'AED',
    totalEvents: 0
  },
  {
    name: 'Desert Palm Polo Club',
    ...
    capacity: 800,
    venueType: VenueType.OUTDOOR,
    facilities: ['Polo Field', 'Equestrian Facilities', 'Garden Area', 'Valet Parking', 'Private Dining'],
    operatingHours: [
    ...
    checkInGates: [
      { gateName: 'Clubhouse Entrance', gateCode: 'GATE08', isActive: true, description: 'Main clubhouse entrance' }
    ],
    baseRentalPrice: 18000,
    currency: 'AED',
    totalEvents: 0
  },
  {
    name: 'Dubai World Trade Centre',
    description: 'Premier exhibition and convention center in the heart of Dubai',
    status: VenueStatus.ACTIVE,
    address: {
      street: 'Trade Centre Road',
      city: 'Dubai',
      state: 'Dubai',
      country: 'UAE',
      zipCode: '45612'
    ...
    capacity: 10000,
    venueType: VenueType.INDOOR,
    facilities: ['Exhibition Halls', 'Meeting Rooms', 'Catering Services', 'Metro Station', 'Parking'],
    operatingHours: [
      { day: 'monday', openTime: '06:00', closeTime: '23:59', isClosed: false },
      { day: 'tuesday', openTime: '06:00', closeTime: '23:59', isClosed: false },
      { day: 'wednesday', openTime: '06:00', closeTime: '23:59', isClosed: false },
      { day: 'thursday', openTime: '06:00', closeTime: '23:59', isClosed: false },
      { day: 'friday', openTime: '06:00', closeTime: '23:59', isClosed: false },
      { day: 'saturday', openTime: '06:00', closeTime: '23:59', isClosed: false },
      { day: 'sunday', openTime: '06:00', closeTime: '23:59', isClosed: false }
    ],
    checkInGates: [
      { gateName: 'Gate A', gateCode: 'GATE09', isActive: true, description: 'Main exhibition entrance' },
      { gateName: 'Gate B', gateCode: 'GATE10', isActive: true, description: 'Secondary entrance' },
      { gateName: 'VIP Gate', gateCode: 'GATE11', isActive: true, description: 'VIP and exhibitor entrance' }
    ],
    baseRentalPrice: 35000,
    currency: 'AED',
    totalEvents: 0
  },
  {
    name: 'The Pavilion Downtown',
    description: 'Elegant rooftop venue with stunning skyline views',
    status: VenueStatus.ACTIVE,
    address: {
      street: 'Burj Khalifa Boulevard',
      city: 'Dubai',
      state: 'Dubai',
      country: 'UAE',
      zipCode: '78901'
    ...
    capacity: 500,
    venueType: VenueType.HYBRID,
    facilities: ['Rooftop Terrace', 'Indoor Lounge', 'Bar Service', 'City Views', 'Photography Areas'],
    operatingHours: [
      { day: 'monday', openTime: '10:00', closeTime: '02:00', isClosed: false },
      { day: 'tuesday', openTime: '10:00', closeTime: '02:00', isClosed: false },
      { day: 'wednesday', openTime: '10:00', closeTime: '02:00', isClosed: false },
      { day: 'thursday', openTime: '10:00', closeTime: '03:00', isClosed: false },
      { day: 'friday', openTime: '10:00', closeTime: '03:00', isClosed: false },
      { day: 'saturday', openTime: '10:00', closeTime: '03:00', isClosed: false },
      { day: 'sunday', openTime: '10:00', closeTime: '02:00', isClosed: false }
    ],
    checkInGates: [
      { gateName: 'Elevator Access', gateCode: 'GATE12', isActive: true, description: 'Express elevator to rooftop' }
    ],
    baseRentalPrice: 22000,
    currency: 'AED',
    totalEvents: 0
  },
  {
    name: 'Al Habtoor City Marina',
    description: 'Waterfront venue perfect for yacht parties and marine events',
    status: VenueStatus.ACTIVE,
    address: {
      street: 'Al Habtoor City, Business Bay',
      city: 'Dubai',
      state: 'Dubai',
      country: 'UAE',
      zipCode: '34567'
    ...
    capacity: 1500,
    venueType: VenueType.OUTDOOR,
    facilities: ['Marina Access', 'Yacht Berths', 'Waterfront Dining', 'Event Deck', 'Water Sports'],
    operatingHours: [
    ...
    checkInGates: [
      { gateName: 'Marina Gate', gateCode: 'GATE13', isActive: true, description: 'Main marina entrance' },
      { gateName: 'Yacht Club', gateCode: 'GATE14', isActive: true, description: 'Private yacht club entrance' }
    ],
    baseRentalPrice: 28000,
    currency: 'AED',
    totalEvents: 0
  }
];
...
const sampleEvents = [
  {
    ...
    description: 'A spectacular showcase of international and local musical talent featuring artists from around the world.',
    category: 'Music',
    type: 'Event',
    venueType: 'Indoor',
    ageRange: [16, 65],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Yes, complimentary parking is available for all ticket holders.'
      }
    ],
    viewsCount: 1250,
    isFeatured: true,
  ...
  },
  {
    ...
    description: 'Connect with innovative startups, investors, and tech enthusiasts in this groundbreaking conference.',
    category: 'Technology',
    type: 'Event',
    venueType: 'Indoor',
    ageRange: [18, 65],
    ...
    faqs: [
      {
        ...
        answer: 'Full day access, lunch, networking sessions, and conference materials.'
      }
    ],
    viewsCount: 890,
    isFeatured: true,
  ...
  },
  {
    ...
    description: 'Relax and rejuvenate with a peaceful yoga session overlooking the beautiful Dubai coastline.',
    ...
    location: {
      ...
      coordinates: { lat: 25.2320, lng: 55.2515 }
    },
    price: 150,
    currency: 'AED',
    isApproved: true,
    ...
    faqs: [
      {
        ...
        answer: 'Please bring your own yoga mat, water bottle, and comfortable clothing.'
      }
    ],
    viewsCount: 456,
    isFeatured: false,
  ...
  },
  {
    ...
    description: 'Learn the secrets of Middle Eastern cuisine from renowned Chef Ahmad in this hands-on cooking experience.',
    ...
    seoMeta: {
      ...
      keywords: ['cooking', 'culinary', 'masterclass', 'middle-eastern', 'dubai']
    },
    faqs: [
      {
  ...
  },
  {
    ...
    description: 'Join global business leaders and entrepreneurs for networking and insights into the future of international trade.',
    category: 'Business',
    type: 'Event',
    venueType: 'Indoor',
    ageRange: [25, 65],
    ...
    faqs: [
      {
        ...
        answer: 'Yes, simultaneous translation in Arabic and English is provided.'
      },
      {
        question: 'What networking opportunities are included?',
        answer: 'Welcome reception, lunch networking sessions, and evening gala dinner.'
      }
    ],
    viewsCount: 1890,
    isFeatured: true,
  ...
  },
  {
    ...
    description: 'Experience authentic Emirati culture with desert adventures, traditional meals, and cultural performances.',
    ...
    seoMeta: {
      ...
      keywords: ['desert', 'safari', 'culture', 'heritage', 'dubai', 'traditional']
    },
    faqs: [
      {
        question: 'What is included in the experience?',
        answer: 'Transportation, camel riding, falconry show, traditional dinner, and cultural performances.'
      },
      {
        question: 'What should I wear?',
        answer: 'Comfortable clothing, closed shoes, and a light jacket for the evening.'
      }
    ],
    viewsCount: 756,
    isFeatured: false,
  ...
  },
  {
    ...
    description: 'Showcase of contemporary Middle Eastern art featuring emerging and established artists from the region.',
    ...
    seoMeta: {
      ...
      keywords: ['art', 'exhibition', 'contemporary', 'middle-eastern', 'design', 'dubai']
    },
    faqs: [
      {
        question: 'How long is the exhibition open?',
        answer: 'The exhibition runs for 30 days with daily access from 10:00 AM to 8:00 PM.'
      },
      {
        question: 'Are guided tours available?',
        answer: 'Yes, guided tours are available at 11:00 AM, 2:00 PM, and 5:00 PM daily.'
      }
    ],
    viewsCount: 445,
    isFeatured: false,
  ...
  },
  {
    ...
    description: 'Intimate jazz performance under the stars with breathtaking views of Dubai\'s skyline.',
    category: 'Music',
    type: 'Event',
    venueType: 'Indoor',
    ageRange: [21, 65],
    ...
    faqs: [
      {
        ...
        answer: 'Smart casual dress code is required. No shorts or flip-flops allowed.'
      },
      {
        question: 'Are drinks included?',
        answer: 'Welcome cocktail is included. Additional drinks can be purchased at the bar.'
      }
    ],
    viewsCount: 678,
    isFeatured: true,
  ...
  },
  {
    ...
    description: 'Exclusive yacht showcase featuring luxury vessels, water sports demonstrations, and marine lifestyle exhibitions.',
    ...
    seoMeta: {
      ...
      keywords: ['yacht', 'marina', 'festival', 'luxury', 'dubai', 'water-sports']
    },
    faqs: [
      {
        question: 'Can I board the yachts?',
        answer: 'Yes, guided tours of selected yachts are available throughout the day.'
      },
      {
        question: 'Are water sports activities included?',
        answer: 'Demonstrations are included. Participation in activities requires separate booking.'
      }
    ],
    viewsCount: 923,
    isFeatured: true,
  ...
  },
  {
    ...
    description: 'Hands-on workshop exploring artificial intelligence applications in business and daily life.',
    category: 'Technology',
    type: 'Course',
    venueType: 'Indoor',
    ageRange: [18, 55],
    ...
    seoMeta: {
      ...
      description: 'Learn practical AI applications in interactive workshop format',
      keywords: ['ai', 'innovation', 'workshop', 'technology', 'training', 'dubai']
    },
    faqs: [
      {
        question: 'Do I need programming experience?',
        answer: 'No programming experience required. Workshop is designed for all skill levels.'
      },
      {
        question: 'What equipment is provided?',
        answer: 'All computers and software are provided. Just bring a notebook for taking notes.'
      }
    ],
    viewsCount: 387,
    isFeatured: false,
  ...
  },
  {
    ...
    description: 'A day of entertainment for the whole family with games, activities, food stalls, and live performances.',
    ...
    seoMeta: {
      ...
      description: 'Perfect family day out with activities and entertainment for everyone',
      keywords: ['family', 'kids', 'entertainment', 'beach', 'dubai', 'outdoor']
    },
    faqs: [
      {
        question: 'What age groups are the activities suitable for?',
        answer: 'Activities are designed for all ages from toddlers to grandparents.'
      },
      {
        question: 'Is food available?',
        answer: 'Yes, various food stalls and vendors will be available throughout the day.'
      }
    ],
    viewsCount: 1456,
    isFeatured: true,
    ...
    for (let j = 0; j < eventsToBook.length; j++) {
      ...
      for (let p = 0; p < quantity; p++) {
        ...
        participants.push({
          ...
          emergencyContact: {
            ...
            relationship: ['Spouse', 'Friend', 'Family', 'Parent', 'Sibling'][Math.floor(Math.random() * 5)],
      ...
      const order = new Order({
        ...
        billingAddress: {
          ...
          address: ['123 Main Street', '456 Business Bay', '789 Marina Walk', '321 Downtown Blvd'][Math.floor(Math.random() * 4)],
          city: 'Dubai',
          state: 'Dubai',
      ...
      if (orderStatus === 'confirmed') {
        for (let k = 0; k < quantity; k++) {
          ...
          const ticket = new Ticket({
            ...
            price: event.price,
            currency: event.currency,
            status: Math.random() > 0.1 ? TicketStatus.ACTIVE : ['cancelled', 'refunded'][Math.floor(Math.random() * 2)] as any,
            checkInDetails: {
              isCheckedIn,
              scanCount: isCheckedIn ? Math.floor(Math.random() * 3) + 1 : 0,
              checkInTime: isCheckedIn ? new Date(event.dateSchedule[0].date.getTime() - Math.random() * 2 * 60 * 60 * 1000) : undefined, // Check-in within 2 hours of event
    ...
    const order = new Order({
      ...
      items: [{
        ...
        participants: Array.from({ length: quantity }, (_, idx) => ({
          name: idx === 0 ? `${randomCustomer.firstName} ${randomCustomer.lastName}` : `Guest ${idx}`,
    ...
    if (orderStatus === 'confirmed') {
      for (let k = 0; k < quantity; k++) {
        ...
        const ticket = new Ticket({
          ...
          qrCodeImage: `/qr/${ticketNumber}.png`,
          ticketType: ticketTypes[Math.floor(Math.random() * ticketTypes.length)],
          attendeeName: k === 0 ? `${randomCustomer.firstName} ${randomCustomer.lastName}` : `Guest ${k}`,
          ...
          checkInDetails: {
            ...
            checkInTime: isCheckedIn ? new Date(randomEvent.dateSchedule[0].date.getTime() - Math.random() * 3 * 60 * 60 * 1000) : undefined,
            checkInLocation: isCheckedIn ? ['Main Entrance', 'VIP Entrance', 'Side Gate'][Math.floor(Math.random() * 3)] : undefined
          },
          validFrom: new Date(),
...
async function seedReviews(users: any[], events: any[], orders: any[]) {
  ...
  const reviewTexts = [
    {
      ...
      comment: 'Absolutely loved this event. The organization was perfect and the venue was beautiful. Every detail was thought through and the staff were incredibly helpful throughout the entire experience.',
      pros: ['Great venue', 'Excellent organization', 'Amazing atmosphere', 'Helpful staff'],
      cons: ['A bit expensive']
    },
    {
      title: 'Good but could be better',
      comment: 'Overall a good experience but there were some issues with the sound system. The event content was interesting but the technical difficulties were distracting.',
      pros: ['Good location', 'Friendly staff', 'Interesting content'],
      cons: ['Sound issues', 'Long queues', 'Technical problems']
    },
    {
      title: 'Highly recommend!',
      comment: 'This was exactly what I was looking for. Will definitely attend again. The venue was perfect and the timing worked well for my schedule.',
      pros: ['Perfect timing', 'Great value', 'Well organized', 'Excellent venue'],
      cons: []
    },
    {
      title: 'Outstanding event!',
      comment: 'Exceeded all my expectations. The quality of speakers and presentations was top-notch. Great networking opportunities and fantastic food.',
      pros: ['High-quality content', 'Great networking', 'Excellent food', 'Professional organization'],
      cons: ['Parking was limited']
    },
    {
      title: 'Disappointing experience',
      comment: 'Had high hopes but the event was not well organized. Long wait times and poor communication from staff. Would not recommend.',
      pros: ['Nice venue'],
      cons: ['Poor organization', 'Long wait times', 'Bad communication', 'Overpriced']
    },
    {
      title: 'Great family event',
      comment: 'Perfect for families with children. Lots of activities and entertainment for all ages. Kids had a blast and parents could relax.',
      pros: ['Family-friendly', 'Good activities for kids', 'Safe environment', 'Good value'],
      cons: ['Could use more shade areas']
    },
    {
      title: 'Professional and well-run',
      comment: 'Very professional event with excellent speakers and well-managed logistics. Perfect for business networking and learning.',
      pros: ['Professional speakers', 'Good logistics', 'Networking opportunities', 'Quality content'],
      cons: ['Could be longer', 'Limited seating']
    },
    {
      title: 'Fun but crowded',
      comment: 'Enjoyed the event but it was quite crowded. Hard to move around and get food. The entertainment was good though.',
      pros: ['Good entertainment', 'Lively atmosphere', 'Variety of activities'],
      cons: ['Too crowded', 'Hard to get food', 'Limited space']
    },
    {
      title: 'Unique experience',
      comment: 'Unlike anything I \'ve attended before. Very creative and innovative approach. Definitely worth the money.',
      pros: ['Unique concept', 'Creative approach', 'Innovative', 'Worth the money'],
      cons: ['Could be clearer instructions']
    },
    {
      title: 'Mediocre at best',
      comment: 'Average event, nothing special. Some parts were good but overall didn\'t live up to the hype. Might consider similar events in the future.',
      pros: ['Some good moments', 'Decent venue'],
      cons: ['Overhyped', 'Average content', 'Not great value']
    },
    {
      title: 'Excellent organization',
      comment: 'Everything ran smoothly from start to finish. Clear instructions, helpful staff, and great timing. Would definitely attend future events.',
      pros: ['Smooth organization', 'Clear instructions', 'Helpful staff', 'Good timing'],
      cons: ['Wish it was longer']
    },
    {
      title: 'Beautiful venue, great atmosphere',
      comment: 'The venue was absolutely stunning and created a perfect atmosphere for the event. Photography opportunities were endless.',
      pros: ['Beautiful venue', 'Great atmosphere', 'Perfect for photos', 'Memorable experience'],
  ...
  for (let i = 0; i < Math.min(confirmedOrders.length * 0.7); i++) { // 70% of confirmed orders get reviews
    ...
    if (rating <= 2) {
      adjustedReviewData = reviewTexts.find(r => r.title.includes('Disappointing') || r.title.includes('Mediocre')) || reviewTexts[4];
    } else if (rating >= 4) {
    ...
    const review = new Review({
      ...
      status: Math.random() > 0.1 ? ReviewStatus.APPROVED : ReviewStatus.PENDING, // 90% approved
  ...
  for (let i = 0; i < 15; i++) {
    ...
    const review = new Review({
      ...
      status: Math.random() > 0.2 ? ReviewStatus.APPROVED : ReviewStatus.PENDING, // 80% approved for unverified
...
async function seedEmployees(users: any[], venues: any[]) {
  ...
  const employeeData = [
    ...
    { firstName: 'Omar', lastName: 'Abdullah', position: 'Security Chief', department: 'Security' },
    { firstName: 'Layla', lastName: 'Mohamed', position: 'Customer Service Rep', department: 'Guest Services' },
    { firstName: 'Khalid', lastName: 'Al-Rashid', position: 'Operations Coordinator', department: 'Operations' },
    { firstName: 'Mariam', lastName: 'Saleh', position: 'Marketing Specialist', department: 'Marketing' },
    { firstName: 'Hassan', lastName: 'Al-Maktoum', position: 'Technical Support', department: 'Technical' },
    { firstName: 'Noor', lastName: 'Abdullah', position: 'Finance Coordinator', department: 'Finance' },
    { firstName: 'Saeed', lastName: 'Al-Ameri', position: 'Venue Coordinator', department: 'Operations' },
    { firstName: 'Amal', lastName: 'Hussain', position: 'Guest Relations Manager', department: 'Guest Services' },
    { firstName: 'Tariq', lastName: 'Al-Zaabi', position: 'Security Officer', department: 'Security' },
    { firstName: 'Zahra', lastName: 'Mohamed', position: 'Event Coordinator', department: 'Operations' },
    { firstName: 'Rashid', lastName: 'Al-Shamsi', position: 'IT Support Specialist', department: 'Technical' },
    { firstName: 'Hanan', lastName: 'Al-Kaabi', position: 'Sales Representative', department: 'Sales' },
    { firstName: 'Mohammed', lastName: 'Al-Nuaimi', position: 'Logistics Manager', department: 'Operations' },
    { firstName: 'Salma', lastName: 'Al-Dhaheri', position: 'HR Coordinator', department: 'Human Resources' },
    { firstName: 'Youssef', lastName: 'Al-Mansouri', position: 'Quality Assurance', department: 'Operations' },
    { firstName: 'Moza', lastName: 'Al-Ketbi', position: 'Public Relations', department: 'Marketing' },
  ...
  vendors.forEach((vendor, vendorIndex) => {
    ...
    for (let i = 0; i < numEmployees; i++) {
      ...
      const employee = new Employee({
        ...
        status: Math.random() > 0.1 ? 'active' : ['inactive', 'suspended'][Math.floor(Math.random() * 2)], // 90% active
        hireDate: new Date(Date.now() - Math.random() * 730 * 24 * 60 * 60 * 1000), // Random date within last 2 years
...
async function seedCheckinLogs(users: any[], events: any[], tickets: any[], employees: any[]) {
  ...
  for (const ticket of checkedInTickets) {
    ...
    const checkinLog = new CheckinLog({
      ...
      deviceInfo: {
        ...
        deviceType: ['mobile', 'tablet', 'scanner'][Math.floor(Math.random() * 3)],
        os: ['iOS', 'Android', 'Windows'][Math.floor(Math.random() * 3)],
        browser: Math.random() > 0.5 ? ['Chrome', 'Safari', 'Firefox'][Math.floor(Math.random() * 3)] : undefined
      },
      scanMethod: ['qr_code', 'manual_entry', 'nfc'][Math.floor(Math.random() * 3)],
      status: Math.random() > 0.05 ? 'successful' : ['failed', 'duplicate'][Math.floor(Math.random() * 2)], // 95% successful
    ...
    if (Math.random() > 0.7) { // 30% chance of additional scans
      ...
      for (let i = 0; i < additionalScans; i++) {
        const additionalLog = new CheckinLog({
          ...
          geoLocation: {
            latitude: (event.location?.coordinates?.lat || 25.2048) + (Math.random() - 0.5) * 0.001,
            longitude: (event.location?.coordinates?.lng || 55.2708) + (Math.random() - 0.5) * 0.001,
  ...
  for (let i = 0; i < failedAttempts; i++) {
    ...
    const failedLog = new CheckinLog({
      ...
      ticketNumber: ticket.ticketNumber,
      attendeeName: ticket.attendeeName,
      checkInTime: new Date(event.dateSchedule[0].date.getTime() - Math.random() * 4 * 60 * 60 * 1000),

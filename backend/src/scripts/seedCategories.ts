...
const categories = [
  {
    ...
    slug: "entertainment",
    description:
      "Fun entertainment activities and events for kids and families",
    icon: "🎭",
    color: "#FF6B35",
    isActive: true,
    level: 0,
    ...
    seoMeta: {
      ...
      description:
        "Discover amazing entertainment events and activities for children across Dubai, Abu Dhabi, and the UAE.",
      keywords: [
        "entertainment",
        "kids events",
        "family fun",
  ...
  },
  {
    ...
    seoMeta: {
      ...
      description:
        "Browse educational workshops, classes, and learning experiences for children in Dubai and UAE.",
  ...
  },
  {
    ...
    seoMeta: {
      ...
      description:
        "Find sports activities, training sessions, and athletic programs for children across the UAE.",
  ...
  },
  {
    ...
    seoMeta: {
      ...
      description:
        "Explore creative arts, crafts, and artistic activities for children in Dubai and UAE.",
  ...
  },
  {
    ...
    seoMeta: {
      ...
      description:
        "Discover thrilling outdoor adventures and exciting experiences for children in the UAE.",
  ...
  },
  {
    ...
    seoMeta: {
      ...
      description:
        "Browse music classes, concerts, and musical events for children in Dubai and UAE.",
  ...
  },
  {
    ...
    seoMeta: {
      ...
      description:
        "Find technology workshops, coding classes, and STEM activities for children in the UAE.",
  ...
  },
  {
    ...
    seoMeta: {
      ...
      description:
        "Explore health, wellness, and fitness activities designed for children in Dubai and UAE.",

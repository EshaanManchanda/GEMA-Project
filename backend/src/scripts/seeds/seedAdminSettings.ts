 ...
 */
export const ensureAdminRevenueSettings = async (
  ...
  try {
    ...
    if (existingSettings) {
      console.log(
        "✅ [AdminSettings] Settings already exist:",
    ...
    console.log(
      "📝 [AdminSettings] Creating default admin revenue settings...",
    );
    ...
    console.error(
      "❌ [AdminSettings] Error creating admin revenue settings:",
      error,
    );

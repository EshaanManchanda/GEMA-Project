...
import { IBlogCategory } from "../models/index";
...
const blogPosts = [
  {
    ...
    excerpt:
      "Discover the best summer activities to keep your kids entertained and engaged during the hot months. From outdoor adventures to creative indoor projects.",
    content: `
    ...
    seo: {
      ...
      metaDescription:
        "Discover amazing summer activities for kids including outdoor adventures and creative indoor projects. Keep your children entertained all season long.",
      metaKeywords: [
        "summer activities",
        "kids activities",
  ...
  },
  {
    ...
    excerpt:
      "A comprehensive guide to selecting educational events that match your child's interests, learning style, and developmental stage.",
    content: `
    ...
    seo: {
      metaTitle:
        "How to Choose Educational Events for Your Child - Parent Guide",
      metaDescription:
        "Learn how to select the best educational events for your child based on their learning style, age, and interests. Expert tips for parents.",
      metaKeywords: [
        "educational events",
        "child education",
        "learning style",
  ...
  },
  {
    ...
    excerpt:
      "Research shows that outdoor play is crucial for physical, cognitive, and emotional development in children. Discover why nature matters.",
    content: `
    ...
    seo: {
      metaTitle:
        "Benefits of Outdoor Play for Child Development - Research-Based Guide",
      metaDescription:
        "Discover the proven benefits of outdoor play for children's physical, cognitive, and emotional development. Expert insights on nature-based learning.",
      metaKeywords: [
        "outdoor play",
        "child development",
        "nature benefits",
  ...
  },
  {
    ...
    excerpt:
      "Step-by-step instructions for planning a memorable and stress-free birthday celebration for your child, from theme selection to party favors.",
    content: `
    ...
    seo: {
      metaTitle:
        "Perfect Birthday Party Planning Guide for Parents - Step by Step",
      metaDescription:
        "Learn how to plan the perfect birthday party for your child with this comprehensive guide. Tips for themes, activities, and stress-free planning.",
      metaKeywords: [
  ...
  },
  {
    ...
    excerpt:
      "Discover affordable and fun activities for the whole family that won't break the bank. Great ideas for urban families on a budget.",
    content: `
    ...
    seo: {
      metaTitle:
        "Budget-Friendly Family Activities - Affordable Fun in the City",
      metaDescription:
        "Discover free and low-cost family activities in your city. Budget-friendly ideas for fun family time without breaking the bank.",
      metaKeywords: [
  ...
  },
  {
    ...
    excerpt:
      "How engaging in arts and crafts activities can boost your child's creative thinking, problem-solving skills, and emotional development.",
    content: `
    ...
    seo: {
      metaTitle:
        "Arts and Crafts Benefits for Children - Creativity and Development",
      metaDescription:
        "Discover how arts and crafts activities boost children's creativity, problem-solving skills, and emotional development. Expert insights and activity ideas.",
      metaKeywords: [
...
async function seedBlogs() {
  try {
    ...
    for (const category of createdCategories) {
      const postCount = createdBlogs.filter(
        (blog) =>
          (blog.category as any).toString() ===
          ((category as any)._id as any).toString(),
      ).length;
    ...
    console.log(
      `Featured posts: ${createdBlogs.filter((blog) => blog.featured).length}`,
    );
  } catch (error) {

...
paymentSchema.methods.addWebhookEvent = function (eventType: string, eventId: string): void {
...
// Static methods
paymentSchema.statics.findByUser = function (userId: string, status?: PaymentStatus) {
...
paymentSchema.statics.findSuccessful = function (startDate?: Date, endDate?: Date) {

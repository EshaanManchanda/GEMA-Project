...
export interface INewsletterSubscriberModel extends Model<INewsletterSubscriber> {
  getActiveSubscribersByFrequency(frequency: string): Promise<INewsletterSubscriber[]>;
...
newsletterSubscriberSchema.virtual('daysSinceSubscription').get(function(this: INewsletterSubscriber) {
...
newsletterSubscriberSchema.statics.getActiveSubscribersByFrequency = function(frequency: string) {
  return this.find({
    isActive: true,
...
newsletterSubscriberSchema.statics.getSubscribersBySource = function(source: string) {
...
export default mongoose.model<INewsletterSubscriber, INewsletterSubscriberModel>('NewsletterSubscriber', newsletterSubscriberSchema);
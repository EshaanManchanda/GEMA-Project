...
affiliateEventClickSchema.index({ clickedAt: 1 }, { expireAfterSeconds: 90 * 24 * 60 * 60 });

const AffiliateEventClick = mongoose.model<IAffiliateEventClick>('AffiliateEventClick', affiliateEventClickSchema);

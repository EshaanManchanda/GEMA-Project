 ...
 */
CommissionTransactionSchema.methods.markAsPaid =
  async function (): Promise<ICommissionTransaction> {
 ...
 */
CommissionTransactionSchema.methods.cancel = async function (
  reason: string,
): Promise<ICommissionTransaction> {
 ...
 */
CommissionTransactionSchema.statics.generateTransactionId =

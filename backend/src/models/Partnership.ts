...
partnershipSchema.statics.getPartnershipStats = async function(): Promise<any> {
...
const Partnership = mongoose.model<IPartnership, IPartnershipModel>('Partnership', partnershipSchema);

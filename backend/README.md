...
npm install
cp .env.example .env
# Configure your .env file (see docs/getting-started.md)
npm run db:seed
npm run dev
```
...
3. **Configure environment variables** (see [deployment.md](docs/deployment.md))
4. **Deploy!**
...
3. **Follow development guidelines**: See [docs/development.md](docs/development.md)
...
**Need help?** Check our [documentation](docs/) or [troubleshooting guide](docs/troubleshooting.md).
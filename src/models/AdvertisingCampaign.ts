...
AdvertisingCampaignSchema.methods.activate =
  async function (): Promise<IAdvertisingCampaign> {
    ...
    this.addCommunication(
      ...
      this.approvedBy || this.vendorId,
    );
    return this.save();
  };

// Method to pause campaign
AdvertisingCampaignSchema.methods.pause = async function (
  reason?: string,
): Promise<IAdvertisingCampaign> {
...
const AdvertisingCampaign = mongoose.model<IAdvertisingCampaign>(
  "AdvertisingCampaign",

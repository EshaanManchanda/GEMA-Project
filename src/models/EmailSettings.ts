...
const EmailSettingsSchema = new Schema<IEmailSettings>(
  {
    ...
    welcomeEmailTemplate: {
      type: String,
      default: () =>
        `<h1>Welcome to ${getBrandConfig().appNameFull}!</h1><p>Thank you for joining our platform.</p>`,
    },
...
const EmailSettings = mongoose.model<IEmailSettings, IEmailSettingsModel>(
  "EmailSettings",
  EmailSettingsSchema,
);

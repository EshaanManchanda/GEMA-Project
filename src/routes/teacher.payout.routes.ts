...
} from "../controllers/teacher.payout.controller";
...
// All teacher payout routes require authentication and teacher role
router.use(authenticate);
router.use(authorize(["teacher"]));

// Dashboard routes
router.get("/dashboard", validateRequest, getTeacherPayoutsDashboard);
...
// Payment settings
router.get("/payment-settings", validateRequest, getPaymentSettings);
...
// Subscription status (for subscription model teachers)
router.get("/subscription-status", validateRequest, getSubscriptionStatus);

// Commission history (for commission model teachers)
router.get(
  "/commission-history",
  pendingEarningsValidation,
  validateRequest,

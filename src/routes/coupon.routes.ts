...
const createCouponValidation = [
  body("code")
    ...
    .matches(/^[A-Z0-9-_]+$/)
    .withMessage(
      "Code must be 3-20 characters and contain only uppercase letters, numbers, hyphens, and underscores",
    ),
  body("name")
    .isString()
...
const applyCouponValidation = [
  body("couponId").isMongoId().withMessage("Coupon ID must be valid"),
...
const bulkUpdateValidation = [
  ...
  body("couponIds.*").isMongoId().withMessage("Coupon ID must be valid"),
  body("status")

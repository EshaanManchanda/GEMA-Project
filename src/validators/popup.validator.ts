...
export const createPopupValidation = [
  ...
  body("image")
    .optional()
    .isMongoId()
    .withMessage("Image must be a valid MediaAsset ID"),
  ...
  body("dismissText")
    ...
    .trim()
    .isLength({ max: 30 })
    .withMessage("Dismiss text cannot exceed 30 characters"),

  body("targetAudience")
    .notEmpty()
    .withMessage("Target audience is required")
    .isIn(["all", "authenticated", "anonymous"])
  ...
  body("targetPages")
    .notEmpty()
    .withMessage("Target pages is required")
    .isIn(["all", "specific"])
    .withMessage("Invalid target pages value"),
  ...
  body("trigger")
    ...
    .isIn(["pageLoad", "timeDelay", "scrollPercent", "exitIntent"])
    .withMessage("Invalid trigger type"),

  body("triggerValue")
    .optional()
    .isInt({ min: 0 })
    .withMessage("Trigger value must be a positive number"),

  body("frequency")
    .notEmpty()
    .withMessage("Frequency is required")
    .isIn(["once", "session", "daily", "always"])
  ...
  body("overlayOpacity")
    .optional()
    .isInt({ min: 0, max: 100 })
    .withMessage("Overlay opacity must be between 0 and 100"),
...
export const updatePopupValidation = [
  param("id").isMongoId().withMessage("Invalid popup ID"),
...
export const updateDisplayOrdersValidation = [
  ...
  body("orders.*.id")
    .isMongoId()
    .withMessage("Each order must have a valid popup ID"),
